...
const Pokemon = () => {
  ...
  return (
    <div className='h-screen w-screen flex flex-col items-center justify-center' style={{backgroundColor:colors[pokemonInfo.type]}} >
        ...
        <div className='flex flex-row w-auto items-center justify-center h-full'>
            <img src={pokemonInfo.img} alt="" srcSet="" className='rounded-full bg_white w-60 h-60 mr-36'/>
